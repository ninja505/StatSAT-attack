...
namespace ckt_n {
    ...
    struct ckt_t
    {
        ...
        std::vector<bool> known_correct_key;
        bool estimated_error = false;
        double est_error_rate=0;
        ...
        // Ankit
        std::vector<double> evaluate_sim(const std::vector<bool> input_values, std::vector<bool> key_values, bool sampling, bool est);  //Ankit
        ...
        std::pair<std::vector<double>,std::vector<double>> evaluate_probs_as(const std::vector<double> input_signal_probs, const std::vector<double> input_error_probs); 
